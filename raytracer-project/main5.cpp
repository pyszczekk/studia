...
#include "objreader.h"
int main(){
	const uint16_t imgWidth3 = 300;
	const uint16_t imgHeight3 = 300;
	JiMP2::BMP bmp3(imgWidth3, imgHeight3);
	bmp3.setBackground();
	unsigned char color3[3]={255,255,255};
	Light light(Vector(0,0,300),1,color3[0],color3[1],color3[2]);
	ObjReader o;
	o.ReadVectors("obj.obj",150,250,0,1);
	...
	std::ofstream outfile("main5.bmp", std::ofstream::binary);
	outfile << bmp3;
